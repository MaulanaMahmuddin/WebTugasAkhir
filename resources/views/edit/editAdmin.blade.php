...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Edit Super Admin</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form id="exampleValidation" action="/superadmin/editAdmin/{{ $user->id }}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="email" class="form-control" name="email" id="email" value="{{ old('email') ? old('email') : $user->email }}" placeholder="Enter Email" required>
                            ...
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <div class="input-file input-file-image">
                                        <img class="img-upload-preview img-circle" width="100" height="100" src="{{ asset('img/foto/'.$user->img)}}" alt="preview">
