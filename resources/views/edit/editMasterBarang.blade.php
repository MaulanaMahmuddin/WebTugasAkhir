...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Edit Master Barang</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form id="exampleValidation" action="/masterBarang/editMasterBarang/{{ $masterBarang->id }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="text" class="form-control" id="kode_b" name="kode_b" value="{{ old('kode_b') ? old('kode_b') : $masterBarang->kode_b }}" required>
                                </div>
                            </div>
                            <div class="form-group form-show-validation row">
                                <label for="name" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Nama Barang <span class="required-label">*</span></label>
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="text" class="form-control" id="nama_b" name="nama_b" value="{{ old('nama_b') ? old('nama_b') : $masterBarang->nama_b }}" required>
                                </div>
                            </div>
                            <div class="form-group form-show-validation row">
                                <label for="berat_b" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Berat Barang <span class="required-label">*</span></label>
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="text" class="form-control" id="berat_b" name="berat_b" value="{{ old('berat_b') ? old('berat_b') : $masterBarang->berat_b }}" required>
                                </div>
                            </div>
                            <div class="form-group form-show-validation row">
                                <label for="qty" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">QTY <span class="required-label">*</span></label>
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <input type="text" class="form-control" id="qty" name="qty" value="{{ old('qty') ? old('qty') : $masterBarang->qty }}" required>
                                </div>
                            </div>
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="harga_b" name="harga_b" value="{{ old('harga_b') ? old('harga_b') : $masterBarang->harga_b }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-show-validation row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-8">
                                    <div class="input-file input-file-image">
                                        <img class="img-upload-preview img-circle" width="100" height="100" src="{{ asset('img/foto/'.$masterBarang->img_b)}}" alt="preview">
